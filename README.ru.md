...
<ul>
<li>мониторинг и контроль эмоциональных состояний ЛПР при работе с СППР и операторов при работе с промышленным оборудованием, станками, пультами управления производственными линиями и другим оборудованием повышенной ответственности.</li>
