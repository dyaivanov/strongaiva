...
The component was developed in C++ using the libraries OpenCV 4.5, OpenPose 1.7, and placed in the repository at https://github.com/dyaivanov/strongaiva To use it, you need the Qt creator compiler.
...
<h2>Test No. 3 (detection of the centers of the pupils of the eyes, determination of the direction of a person's gaze)</h2>
...
<h2>Test No. 6 (detection of problem areas of interaction between an individual and DSS)</h2>
